...
from lpips import trainer_ariqa_sal_edge as trainer
...
train_loader = torch.utils.data.DataLoader(dataset=ARIQA_dataset_train,batch_size=opt.batch_size,shuffle=True,num_workers=0)
...
# test_results = np.load(os.path.join(opt.save_dir,'test.npy'))
test_dataframe = []
