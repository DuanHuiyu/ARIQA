...
if ((mx > 0) & ~strcmp(params.shapeMode,'shapeSM'))
  ...
  CMidx = CMidx(randInt(length(CMidx)));
  ...
  if ((mx > 0) & ~strcmp(params.shapeMode,'shapeCM'))
    ...
    FMidx = FMidx(randInt(length(FMidx)));
...
shapeData.segmentedMap.date = timeString;
